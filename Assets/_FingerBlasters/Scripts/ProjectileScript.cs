...
{
    // all the components for the particle effects of the bullet
    ...
    //The damage that the bullet does on hit
    ...
    void FixedUpdate()
    {
        ...
        if (Physics.SphereCast(transform.position, rad, dir, out hit, dist))
        {
            ...
            {
                NPCStats npc = hit.transform.gameObject.GetComponentInParent<NPCStats>();
